...
namespace Microsoft.SqlServer.TDS.EndPoint.SSPI
{
    ...
    public class SSPIContext: IDisposable
    {
        ...
        /// </summary>
        private int MaxTokenBufferSize;
        ...
        private SSPIContext()
        {
            ...
            foreach (string package in packages)
            {
                ...
                try
                {
                    ...
                    if (info.MaxToken > MaxTokenBufferSize)
                    {
                        // Use the token size
                        MaxTokenBufferSize = info.MaxToken;
                    }
                }
                finally
                {
        ...
        public SSPIResponse StartServerAuthentication(byte[] clientToken)
        {
            ...
            try
            {
                ...
                SecBufferDesc serverSecBuffer = new SecBufferDesc(MaxTokenBufferSize);
        ...
        public SSPIResponse StartClientAuthentication(string targetMachine, uint targetPort)
        {
            ...
            SecBufferDesc clientSecBuffer = new SecBufferDesc(MaxTokenBufferSize);
