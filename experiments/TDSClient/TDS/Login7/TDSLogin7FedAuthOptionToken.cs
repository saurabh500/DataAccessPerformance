...
namespace Microsoft.SqlServer.TDS.Login7
{
    ...
    public class TDSLogin7FedAuthOptionToken : TDSLogin7FeatureOptionToken
    {
        ...
        /// </summary>
        public TdsPreLoginFedAuthRequiredOption Echo { get; set; }

        /// <summary>
        /// Whether this protocol is requesting further information from server to perform authentication.
        /// </summary>
        public bool IsRequestingAuthenticationInfo { get; set; }
        ...
        /// </summary>
        public byte[] ChannelBingingToken { get; set; }
        ...
        public TDSFedAuthADALWorkflow Workflow { get; set; }
